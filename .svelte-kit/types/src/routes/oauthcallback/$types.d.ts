...
type LayoutRouteId = RouteId | "/oauthcallback"
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/oauthcallback/+page.server.js').load>>>>>>;
